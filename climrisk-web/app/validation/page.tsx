...
const SOURCES = [
  ...
  "NASA NEX-GDDP-CMIP6",
  "NGFS Phase 4",
  "IPCC AR6 WG2 hazard matrices",
  "IPCC AR6 WG1 sea level rise",
  "JRC LISFLOOD-FP flood rasters",
  "JRC Huizinga 2017 depth-damage curves",
  "Munich Re NatCatSERVICE",
  "WDPA / IUCN protected areas",
  "ENCORE v1.1 (UNEP-WCMC)",
  "PCAF Global Standard, Part A",
  "SFDR RTS Annex I",
  "SBTn high-priority sectors",
